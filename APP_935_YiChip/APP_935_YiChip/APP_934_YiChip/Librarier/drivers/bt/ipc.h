...
/**
  *@brief IPC a2dp callback function type.
  */
typedef void (*tIPCReadReq)(uint8_t*, uint16_t);
...
typedef struct IPCContolBlock {
	...
	tIPCReadReq readreqcb;	/*< ipc read request call back */
}tIPCControlBlock;
...
/**
  ...
  *@return None.
  */
uint8_t IPC_IsRxBuffEmpty(void);
...
/**
  ...
  *@return None.
  */
void IPC_clear_flag(void);
void Ble_RecviceBleIpc(void);
